...
@RestController
@RequestMapping("cmis/services")
public class CMISRepositoryController {

	Logger log = Logger.getLogger(CMISRepositoryController.class.getCanonicalName());
	...
	public ArrayList<DocumentumObject> searchDocumentByName(@PathVariable(value = "name") String name) throws RepositoryNotAvailableException {
