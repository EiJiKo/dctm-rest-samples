...
public class DocumentumIntegrationController {
	...
	public DocumentumFolder createFolder(@PathVariable(value="api") String api, @PathVariable(value = "cabinetName") String cabinetName,
			@PathVariable(value = "folderName") String folderName) throws DocumentumException, DelegateNotFoundException {
		try {
	...
	public DocumentumDocument createDocument(@PathVariable(value="api") String api, @RequestBody DocumentCreation docCreation) throws DocumentumException, DelegateNotFoundException {
		try {
	...
	public DocumentumFolder getCabinetByName(@PathVariable(value="api") String api, @PathVariable(value = "cabinetName") String cabinetName)
	...
	public DocumentumObject getCabinetById(@PathVariable(value="api") String api,@PathVariable(value = "cabinetId") String cabinetId)
			throws CabinetNotFoundException, RepositoryNotAvailableException, DelegateNotFoundException {
	...
	public ArrayList<DocumentumFolder> getAllCabinets(@PathVariable(value="api") String api) throws RepositoryNotAvailableException, DelegateNotFoundException {
		return (delegateProvider.getDelegate(api)).getAllCabinets();
	}

	@CrossOrigin("*")
	@RequestMapping(value = "get/{folderId}/children")
	public ArrayList<DocumentumObject> getChildren(@PathVariable(value="api") String api,@PathVariable(value = "folderId") String folderId) throws Exception {
		return (delegateProvider.getDelegate(api)).getChildren(folderId);
	}

	@RequestMapping(value = "get/document/content/id/{documentId}")
	public Object getDocumentContentById(@PathVariable(value="api") String api,@PathVariable(value = "documentId") String documentId)
	...
	public ArrayList<DocumentumObject> searchDocumentByName(@PathVariable(value="api") String api,@PathVariable(value = "name") String name) throws RepositoryNotAvailableException, DelegateNotFoundException {
