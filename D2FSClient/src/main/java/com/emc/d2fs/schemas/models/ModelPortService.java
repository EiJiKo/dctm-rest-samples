...
/**
 * This class was generated by Apache CXF 3.1.5 2016-03-28T17:45:08.251+02:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "ModelPortService", wsdlLocation = "META-INF/wsdl/d2fs.wsdl.xml", targetNamespace = "http://www.emc.com/d2fs/schemas/models")
public class ModelPortService extends Service {
	...
	static {
		...
		url = com.emc.d2fs.schemas.models.ModelPortService.class.getResource("/META-INF/wsdl/d2fs.wsdl.xml");
		java.util.logging.Logger.getLogger(ModelPortService.class.getName()).log(java.util.logging.Level.INFO,
				(url.toString()));
		if (url == null) {
			java.util.logging.Logger.getLogger(ModelPortService.class.getName()).log(java.util.logging.Level.INFO,
					"Cannot find 'META-INF/wsdl/d2fs.wsdl.xml' Place the resource correctly in the class path");
		}
